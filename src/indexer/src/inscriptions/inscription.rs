use {
  super::{envelope, media::Media, tag::Tag, InscriptionId}, 
  crate::{chain::Chain, default}, 
  anyhow::{bail, ensure, Context, Error}, 
  // axum::http::header::HeaderValue, 
  bitcoin::{blockdata::opcodes, constants::MAX_SCRIPT_ELEMENT_SIZE, hashes::Hash, script, Txid}, 
  brotli::enc::{writer::CompressorWriter, BrotliEncoderParams}, 
  ciborium::Value, ordinals::Rune, serde::{Deserialize, Serialize}, 
  std::{fs, io::{Cursor, Read, Write},
  path::PathBuf, str}
};
...
impl Inscription {
  ...
  #[cfg(test)]
  pub(crate) fn append_reveal_script(&self, builder: script::Builder) -> script::ScriptBuf {
...
mod tests {
  use {
    crate::{chain::Chain, default, inscriptions::Inscription, test::{envelope, inscription}}, bitcoin::script, std::io::Write};
